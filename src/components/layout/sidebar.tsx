  ...
  return (
    <aside className="hidden md:flex flex-col fixed left-0 top-0 z-30 h-screen w-60 bg-black/60 backdrop-blur-xl border-r border-white/[0.04]">
      ...
      <div className="border-t border-white/[0.04] p-2">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-300 hover:bg-white/[0.02] cursor-pointer">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs font-light text-white/40 truncate">marcus@databuks.com</p>
          </div>
