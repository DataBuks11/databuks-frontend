...
export const websiteAnalysisSchema = z
  .object({
    ...
    industries: z.array(z.string().min(1).max(200)).max(20),
    ...
    locations: z.array(z.string().min(1).max(300)).max(20),
    ...
    content_themes: z.array(websiteContentThemeSchema).max(20),
    business_signals: z.array(websiteSignalSchema).max(20),
    brand_voice: z.array(z.string().min(1).max(100)).max(10),
    tone: z.string().max(100).nullable(),
